# About MATSAS
MATSAS (MATLAB for Small-Angle Scattering) is an open-source package for analysing small-angle scattering (SAS) data from neutron and X-ray experiments on porous systems and other complex materials.

Originally developed for sedimentary rocks, MATSAS is now a versatile analysis suite applicable to biological macromolecules, composite nanomaterials, polymers, and engineered porous media.
...
The latest release, MATSAS R2025.1, includes enhanced Porod calculation, improved invariant robustness, and several bug fixes.
We welcome contributions, comments, and source code improvements from the SAS community via GitHub’s forums or the MATSAS Development Team. See "Releases".
Amirsaman Rezaeyan;
